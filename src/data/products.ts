...
export const FAQ_ITEMS = [
  {
    ...
    answer:
      "لحومنا الطازة بتتقطع يوميًا في الجزارة. كل طلب بيتغلف بشكل نظيف ومحكم قبل ما يخرج ليك.",
  },
  {
    id: "quality-delivery",
    question: "إزاي بتحافظوا على الجودة أثناء التوصيل؟",
    answer:
      "بنغلف الطلب بعناية ونسلّمه في أسرع وقت. التوصيل داخل بني سويف، وكمان تقدر تستلم من أي فرع من فروعنا الثلاثة.",
  },
  {
    id: "custom-cut",
  ...
  },
  {
    ...
    answer:
      "التوصيل داخل بني سويف في نفس اليوم حسب وقت الطلب والمنطقة. هنأكدلك الميعاد على واتساب بعد ما تبعت الطلب.",
  },
  {
    id: "payment",
